...
import {
  fetchProperty,
  fetchWishlist
} from "../../redux/sagas/property/fetchSaga"
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Tab.Screen
          ...
          options={{ tabBarLabel: "Wishlisted" }}
        />
        <Tab.Screen
          name="Recomendations"
          component={Recomendations}
          options={{ tabBarLabel: "Personalized Recomendations" }}
        />
      </Tab.Navigator>
...
const Nearby = () => {
  ...
  if (isLoading) return <PropertyLoader />
  ...
  return (
    <FlatList
      ...
      ListEmptyComponent={() => (
        <ListEmpty text="No items to display" height={hp("80%")} />
      )}
...
const Wishlisted = () => {
  ...
  useEffect(() => {
    if (isWishlistUpdated) dispatch(fetchWishlist())
  }, [isWishlistUpdated])
