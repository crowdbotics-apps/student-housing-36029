...
const ApiService = {
  ...
  forgetPassSend: params => post(`/api/v1/rest-auth/password/reset/`, params),
  ...
  updatePhoneNUMber: params =>
    post(`/api/v1/user/update-phone-number/`, params),
  ...
  updateHouseRule: (id, params) =>
    patch(`/api/v1/housing-rules/${id}/`, params),
